					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">On sale<span>.</span></div>
								<div class="home_text"><p>Until supply last</p></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="product_grid">
                        @for($i=0; $i < 3; $i++)
							...
							<div class="product_content">
								<div class="product_title"><a href="{{ route('SProduct.view', ['post_id' => $recommend[$i]->id]) }}">{{$recommend[$i]->product_name}}</a></div>
								<div class="product_price">₱{{$recommend[$i]->price}}</div>
							</div>
						</div>
                        @endfor
