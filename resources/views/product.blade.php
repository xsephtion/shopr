					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">Shop Now<span>.</span></div>
								<div class="home_text"><p>We are now in a sale! Hurry! Until supply last.</p></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col">
					...
					<div class="sorting_bar d-flex flex-md-row flex-column align-items-md-center justify-content-md-start">
						<div class="results">Showing <span>{{sizeof($products)}}</span> results</div>
